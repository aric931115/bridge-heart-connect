...
import { MapPin, Clock, Users, Volume2, CheckCircle2, Circle, LogIn } from 'lucide-react';
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="space-y-3">
          ...
          {activity.tasks.map(task => (
            <div
              key={task.id}
              className={`card-accessible flex items-start gap-3 ${!activity.joined ? 'opacity-60' : ''}`}
            >
              <button
          ...
          {activity.joined && (
            <Link
              to={`/activities/${activity.id}/room`}
              className="block"
            >
