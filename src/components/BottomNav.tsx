...
import { Calendar, CalendarPlus, Users, UserCircle, Settings } from 'lucide-react';

const tabs = [
  { path: '/activities', label: '活動大廳', icon: Calendar },
  { path: '/activities/create', label: '建立活動', icon: CalendarPlus },
